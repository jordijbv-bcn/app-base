package com.base.app.application.web.component.datatable;
...
public class DataTableUtil {
	...
	public static <T> String getDataTableResultsToJson(Page entity, List model, DataTableRequest dataTableInRQ, DataTableResults<T> dataTableResult) {
		dataTableResult.setDraw(dataTableInRQ.getDraw());
		dataTableResult.setListOfDataObjects(model);
		if (!isObjectEmpty(model)) {
			dataTableResult.setRecordsTotal(Long.toString(entity.getTotalElements()));
			if (dataTableInRQ.getPaginationRequest().isFilterByEmpty()) {
				dataTableResult.setRecordsFiltered(Long.toString(entity.getTotalElements()));
			} else {
				dataTableResult.setRecordsFiltered(Long.toString(entity.getTotalElements()));
			}
		} else {
			dataTableResult.setRecordsFiltered(Long.toString(model.size()));
			dataTableResult.setRecordsTotal(Long.toString(entity.getTotalElements()));
		}
